...
Run once after speakers_selected.txt is finalised:
    uv run src/linguistic_prompting/data/prepare_dataset.py

Produces data/processed/linguistic_prompting/tedlium_selected/
...
_DEFAULT_SPEAKERS_FILE = Path("src/linguistic_prompting/data/speaker_selection/speakers_selected.txt")
_DEFAULT_OUTPUT_DIR    = Path("data/processed/linguistic_prompting/tedlium_selected")
