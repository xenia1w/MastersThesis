...
#          src/linguistic_prompting/slurm/run_earnings21_fullcall_transcript_plus_knowledge.sh
#
# Merge (numeric glob, ignores the aggregate):
#   uv run python -c "
#   import glob, pandas as pd
#   d='data/processed/linguistic_prompting/earnings21_fullcall_transcript_plus_knowledge'
...
OUTPUT_DIR="data/processed/linguistic_prompting/earnings21_fullcall_transcript_plus_knowledge${SUFFIX}"
