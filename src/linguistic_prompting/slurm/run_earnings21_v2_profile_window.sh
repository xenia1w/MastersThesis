...
#          src/linguistic_prompting/slurm/run_earnings21_v2_profile_window.sh
#
...
#     --transcripts-dir data/processed/linguistic_prompting/v2/profile_transcripts \
#     --skip-existing
# =============================================================================
...
OUTPUT_DIR="data/processed/linguistic_prompting/v2/profile_transcripts"
...
python -m src.linguistic_prompting.pipeline.earnings21_window_profile \
