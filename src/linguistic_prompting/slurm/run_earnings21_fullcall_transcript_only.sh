#!/bin/bash
# =============================================================================
# run_earnings21_fullcall_transcript_only.sh
# One array task per call — full-call transcript_only evaluation. The LLM keyword
...
#          src/linguistic_prompting/slurm/run_earnings21_fullcall_transcript_only.sh
#
# Merge (numeric glob, ignores the aggregate):
#   uv run python -c "
#   import glob, pandas as pd
#   d='data/processed/linguistic_prompting/earnings21_fullcall_transcript_only'
...
#SBATCH --job-name=earnings21-fullcall-transcript-only
...
#SBATCH --output=/home/users/x/xenia1w/MastersThesis/logs/earnings21_fullcall_transcript_only_%A_%a.out
#SBATCH --error=/home/users/x/xenia1w/MastersThesis/logs/earnings21_fullcall_transcript_only_%A_%a.err
...
OUTPUT_DIR="data/processed/linguistic_prompting/earnings21_fullcall_transcript_only${SUFFIX}"
...
echo "=== Earnings21 fullcall transcript_only started: $(date) ==="
...
echo "=== Earnings21 fullcall transcript_only finished: $(date) ==="
