...
#          src/linguistic_prompting/slurm/run_earnings21_v2_baseline.sh
#
# Merge after all tasks complete (numeric glob ignores the aggregate):
#   uv run python -c "
#   import glob, pandas as pd
#   d='data/processed/linguistic_prompting/v2/earnings21_window_baseline'
...
OUTPUT_DIR="data/processed/linguistic_prompting/v2/earnings21_window_baseline"
...
python -m src.linguistic_prompting.pipeline.earnings21_window_eval \
