...
#          src/linguistic_prompting/slurm/run_earnings21_fullcall_metadata_only.sh
#
...
#   d='data/processed/linguistic_prompting/earnings21_fullcall_metadata_only'
...
OUTPUT_DIR="data/processed/linguistic_prompting/earnings21_fullcall_metadata_only${SUFFIX}"
