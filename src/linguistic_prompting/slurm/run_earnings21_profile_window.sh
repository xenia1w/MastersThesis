...
#          src/linguistic_prompting/slurm/run_earnings21_profile_window.sh
#
...
#     data/processed/linguistic_prompting/profile_transcripts/ \
#     data/processed/linguistic_prompting/profile_transcripts/
# =============================================================================
...
OUTPUT_DIR="data/processed/linguistic_prompting/profile_transcripts"
...
python -m src.linguistic_prompting.pipeline.earnings21_profile_window \
    --model         medium \
