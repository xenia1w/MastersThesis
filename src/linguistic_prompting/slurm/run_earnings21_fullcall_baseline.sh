...
#          src/linguistic_prompting/slurm/run_earnings21_fullcall_baseline.sh
#
...
#   d='data/processed/linguistic_prompting/earnings21_fullcall_baseline'
...
OUTPUT_DIR="data/processed/linguistic_prompting/earnings21_fullcall_baseline"
