...
Usage:
    uv run -m src.linguistic_prompting.comparison.compare_all
    uv run -m src.linguistic_prompting.comparison.compare_all --approach metadata_only --approach transcript_only
"""
...
from src.linguistic_prompting.comparison import loaders, metrics
from src.linguistic_prompting.comparison.compare_approach import PATHOLOGICAL_WER
