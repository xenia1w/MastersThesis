...
Usage:
    uv run -m src.linguistic_prompting.pipeline.earnings21_profile_window \\
...
from src.linguistic_prompting.data.earnings21_utils import load_earnings21
from src.linguistic_prompting.models.constants import PROFILE_TRANSCRIPTS_DIR
