...
``earnings21_window_score.py`` expects, so scoring needs no changes::
    ...
    uv run -m src.linguistic_prompting.pipeline.earnings21_window_score \\
...
Usage:
    # blind
    uv run -m src.linguistic_prompting.pipeline.earnings21_posthoc_correct --skip-existing
    # context (0:00-5:00 self-reference)
    uv run -m src.linguistic_prompting.pipeline.earnings21_posthoc_correct \\
...
from src.linguistic_prompting.models.constants import DEFAULT_LLM_MODEL
from src.linguistic_prompting.models.prompts import (
...
from src.linguistic_prompting.models.speaker_profile import _get_client, _llm_call

DEFAULT_BASELINE = Path(
    "data/processed/linguistic_prompting/v2/earnings21_window_baseline/baseline_all.csv"
)
DEFAULT_OUT_DIR = Path(
    "data/processed/linguistic_prompting/v2/earnings21_window_posthoc_blind"
)
...
DEFAULT_CONTEXT_OUT_DIR = Path(
    "data/processed/linguistic_prompting/v2/earnings21_window_posthoc_context"
)
DEFAULT_PROFILE_TRANSCRIPTS_DIR = Path(
    "data/processed/linguistic_prompting/v2/profile_transcripts"
)
...
PROFILES_ROOT = Path("data/processed/linguistic_prompting/v2/profiles")
...
POSTHOC_OUT_ROOT = Path("data/processed/linguistic_prompting/v2")
