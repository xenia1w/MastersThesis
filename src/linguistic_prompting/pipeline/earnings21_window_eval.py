...
Usage (baseline, no prompt):
    uv run -m src.linguistic_prompting.pipeline.earnings21_window_eval \\
        --data-dir   data/raw/earnings21 \\
        --call-id    4392809 \\
        --eval-start 300 --eval-end 900 \\
        --strategy   baseline \\
        --output     data/processed/linguistic_prompting/v2/earnings21_window_baseline/baseline_4392809.csv
"""
