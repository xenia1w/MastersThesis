...
Usage:
    uv run -m src.linguistic_prompting.pipeline.smoke_test_fullcall \\
...
from src.linguistic_prompting.models.constants import PROFILES_DIR
from src.linguistic_prompting.models.speaker_profile import (
    ProfileStrategy,
    load_profile,
)
from src.linguistic_prompting.pipeline.earnings21_fullcall_eval import evaluate_call
