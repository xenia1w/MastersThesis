...
Usage:
    uv run -m src.linguistic_prompting.pipeline.earnings21_window_score \\
        ...
        --annotations  data/processed/linguistic_prompting/v2/annotations.csv \\
        --base-dir     data/processed/linguistic_prompting/v2 \\
...
from src.linguistic_prompting.pipeline.earnings21_fullcall_eval import (
...
def main() -> None:
    ...
    parser.add_argument("--base-dir", type=Path,
                        default=Path("data/processed/linguistic_prompting/v2"))
