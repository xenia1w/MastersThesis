...
Usage:
    uv run -m src.linguistic_prompting.pipeline.earnings21_fullcall_eval \\
        --data-dir     data/raw/earnings21 \\
        --output       data/processed/linguistic_prompting/earnings21_fullcall_metadata_only/prompted_4392809.csv \\
