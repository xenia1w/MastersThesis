...
Usage:
    uv run -m src.linguistic_prompting.pipeline.compare_fullcall \\
        --baseline data/processed/linguistic_prompting/earnings21_fullcall_baseline/baseline_all.csv \\
        --prompted data/processed/linguistic_prompting/earnings21_fullcall_metadata_only/prompted_all.csv \\
        --output   data/processed/linguistic_prompting/earnings21_fullcall_metadata_only/comparison.csv
"""
