...
from src.acoustic_feature_extraction.models.acoustic import AcousticEmbedding, SAAMetadata, SAASample
...
class SAAMinimalController:
    ...
    def encode_sample(self, sample: SAASample) -> AcousticEmbedding:
    ...
    def run(self, samples: Iterable[SAASample]) -> List[AcousticEmbedding]:
        results = []
