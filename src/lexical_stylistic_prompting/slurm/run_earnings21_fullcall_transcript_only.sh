...
#   d='data/processed/lexical_stylistic_prompting/earnings21_fullcall_transcript_only'
...
OUTPUT_DIR="data/processed/lexical_stylistic_prompting/earnings21_fullcall_transcript_only${SUFFIX}"
