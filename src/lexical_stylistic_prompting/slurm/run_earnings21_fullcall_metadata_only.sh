...
# One array task per earnings call — full-call evaluation with metadata_only
...
#       'data/processed/lexical_stylistic_prompting/earnings21_fullcall_metadata_only/prompted_*.csv'))]
#   pd.concat(dfs).to_csv(
#       'data/processed/lexical_stylistic_prompting/earnings21_fullcall_metadata_only/prompted_all.csv',
#       index=False)
...
OUTPUT_DIR="data/processed/lexical_stylistic_prompting/earnings21_fullcall_metadata_only"
