...
#          src/lexical_stylistic_prompting/slurm/run_earnings21_fullcall_transcript_metadata_knowledge.sh
#
# Merge (numeric glob, ignores the aggregate):
#   uv run python -c "
#   import glob, pandas as pd
#   d='data/processed/lexical_stylistic_prompting/earnings21_fullcall_transcript_metadata_knowledge'
